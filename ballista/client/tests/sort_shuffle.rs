...
mod sort_shuffle_tests {
    ...
    use ballista_core::config::{
        BALLISTA_PLANNER_ADAPTIVE, BALLISTA_SHUFFLE_READER_FORCE_REMOTE_READ,
    ...
    async fn create_sort_shuffle_context(read_mode: ReadMode) -> SessionContext {
        let mut config = SessionConfig::new_with_ballista()
            ...
            .set_bool(BALLISTA_PLANNER_ADAPTIVE, false) // AQE does not support sort shuffle at the moment
